...
function index() {
  ...
  const backgroundClassname = dark === "/Agile " ? "aboutus-gradient" : "";
  return (
      ...
      <div className="container section-divide-margin content">
        ...
        <div className="row">
          <div className="col-lg-6">
            <img src="./assets/images/b3.png" className="img-fluid"></img>
          </div>
          <div className="col-lg-6 mt-5 ">
            <ScrollAnimation
              ...
              animateOnce={true}
            >
              <p className="blog-grey mt-5">Agile </p>
          ...
          >
            <div className="mt-5">
              <h5>What is Agile ?</h5>
              <p className="grey">
                Agile stands for MongoDB, Express, React, Node, after the four
              ...
              <h5>How does the Agile work?</h5>
              <p className="grey">
                The Agile architecture allows you to easily construct a
